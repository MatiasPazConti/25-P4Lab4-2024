...
int main()
{
  ...
  /*
     ...
     DTProducto *PR1 = new DTProducto(idPR1, nombrePR1, descripcionPR1, precioPR1, stockPR1, tipoPR1);
     US2.addProducto(PR1);
     ...
     DTProducto *PR2 = new DTProducto(idPR2, nombrePR2, descripcionPR2, precioPR2, stockPR2, tipoPR2);
     US1.addProducto(PR2);
     ...
     DTProducto *PR3 = new DTProducto(idPR3, nombrePR3, descripcionPR3, precioPR3, stockPR3, tipoPR3);
     US2.addProducto(PR3);
     ...
     DTProducto *PR4 = new DTProducto(idPR4, nombrePR4, descripcionPR4, precioPR4, stockPR4, tipoPR4);
     US1.addProducto(PR4);
     ...
     DTProducto *PR5 = new DTProducto(idPR5, nombrePR5, descripcionPR5, precioPR5, stockPR5, tipoPR5);
     US3.addProducto(PR5);
     ...
     DTProducto *PR6 = new DTProducto(idPR6, nombrePR6, descripcionPR6, precioPR6, stockPR6, tipoPR6);
     US2.addProducto(PR6);
     ...
     DTProducto *PR7 = new DTProducto(idPR7, nombrePR7, descripcionPR7, precioPR7, stockPR7, tipoPR7);
     US3.addProducto(PR7);
     ...
     DTProducto *PR8 = new DTProducto(idPR8, nombrePR8, descripcionPR8, precioPR8, stockPR8, tipoPR8);
     US1.addProducto(PR8);
     ...
     DTProducto *PR9 = new DTProducto(idPR9, nombrePR9, descripcionPR9, precioPR9, stockPR9, tipoPR9);
     US1.addProducto(PR9);
     ...
     DTProducto *PR10 = new DTProducto(idPR10, nombrePR10, descripcionPR10, precioPR10, stockPR10, tipoPR10);
     ...
     DTProducto *PR11 = new DTProducto(idPR11, nombrePR11, descripcionPR11, precioPR11, stockPR11, tipoPR11);
     ...
     DTProducto *PR12 = new DTProducto(idPR12, nombrePR12, descripcionPR12, precioPR12, stockPR12, tipoPR12);
     ...
     DTProducto *PR13 = new DTProducto(idPR13, nombrePR13, descripcionPR13, precioPR13, stockPR13, tipoPR13);
     ...
     DTProducto *PR14 = new DTProducto(idPR14, nombrePR14, descripcionPR14, precioPR14, stockPR14, tipoPR14);
     ...
     DTProducto *PR15 = new DTProducto(idPR15, nombrePR15, descripcionPR15, precioPR15, stockPR15, tipoPR15);
